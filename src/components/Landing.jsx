...
export default function LandingBallpit() {
  return (
    <section className="w-full bg-slate-950 h-screen">
      <div className="relative overflow-hidden w-full h-screen">
        ...
        <Ballpit
          ...
          colors={[
            0x22d3ee, // cyan-400
            0x38bdf8, // sky-400
            0x22c55e, // emerald-500
            0x6366f1, // indigo-500
          ]}
        />

        {/* Optional: text overlay di atas bola */}
        <div className="pointer-events-none absolute inset-0 flex flex-col items-center justify-center text-center mx-auto  max-w-7xl px-4 sm:px-6 lg:px-8 top-0">
